...
sealed class LyricsParentNode extends LyricsNode {
  const LyricsParentNode(this.children, {
    super.style,
  });
...
class LyricsTextNode extends LyricsNode {
  const LyricsTextNode(this.text, {
    super.style,
  });
...
class LyricsRtNode extends LyricsParentNode {
  const LyricsRtNode(super.children, {
    super.style,
  });
...
class LyricsRubyNode extends LyricsParentNode {
  const LyricsRubyNode(super.children, {
    super.style,
  });

  factory LyricsRubyNode.from(String ruby, String rt) {
    return LyricsRubyNode([
      LyricsTextNode(ruby),
      LyricsRtNode.from(rt),
    ]);
  }
